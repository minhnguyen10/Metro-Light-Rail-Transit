...
model %>% fit(x = data.matrix(tree_data[,-label_ind]),y = to_categorical(tree_data[,label_ind]), epochs=25, batch_size = 256, validation_split=.2)
...
model %>% fit(x = data.matrix(tree_data[,-label_ind]),y = to_categorical(tree_data[,label_ind]), epochs=20, validation_split=.2, batch_size = 256)
...
model %>% fit(x = data.matrix(tree_data[,-label_ind]),y = to_categorical(tree_data[,label_ind]), epochs=24, validation_split=.2)
...
model %>% fit(x = data.matrix(tree_data[,-label_ind]),y = to_categorical(tree_data[,label_ind]), epochs=50, batch_size = 256, validation_split=.2)
